...
CREATE TABLE IF NOT EXISTS `MOU`.`MOU_CUSTOMER` (
  ...
  PRIMARY KEY (`CUSTOMER_ID`, `ID_TYPE`, `ID_NUMBER`),
...
CREATE TABLE IF NOT EXISTS `MOU`.`MOU_AGREEMENT` (
  ...
  PRIMARY KEY (`AGREEMENT_KEY`, `ID_TYPE`, `ID_NUMBER`),
...
CREATE TABLE IF NOT EXISTS `MOU`.`CUSTOMER_MOU_AGREEMENT` (
  ...
  `MOU_CUSTOMER_ID` VARCHAR(50) NOT NULL,
  `MOU_AGREEMENT_ID` INT NOT NULL,
  PRIMARY KEY (`CUSTOMER_MOU_AGREEMENT_ID`),
  INDEX `fk_customer_mou_agreement_mou_agreement1_idx` (`MOU_AGREEMENT_ID` ASC),
  ...
  CONSTRAINT `fk_CUSTOMER_MOU_AGREEMENT_MOU_CUSTOMER1`
    ...
    REFERENCES `MOU`.`MOU_CUSTOMER` (`ID_NUMBER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `MOU`.`budget` (
  ...
  CONSTRAINT `fk_budget_customer1`
    ...
    REFERENCES `MOU`.`MOU_CUSTOMER` (`ID_TYPE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
